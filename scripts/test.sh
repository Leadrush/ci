...
CASPER_OPTIONS="--fail-fast --direct --log-level=debug --capture_path=$SCREENSHOTDATE --includes=./ci/tests/casperjs/pre.js --base_url=$URL --cookies-file=./ci/tests/casperjs/cookie.txt"
